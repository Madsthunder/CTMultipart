...
{
	/**
	 * @param access The {@link IBlockAccess}.
	 * @param pos The {@link BlockPos} of the TileEntityMultiblock.
	 * @param state The {@link IBlockState} returned by {@link Block#onBlockPlaced}.
	 * @param multiblock The container for all of the existing {@link MultipartState} instances.
	 * @param result Hit information.
	 * @return Whether this {@link Multipart} can be placed in the provided TileEntityMicroblock.
	 */
	...
	/**
	 * @param info Information that could be useful.
	 * @return A list of ICuboid instances that can be selected to show this Multipart instance
	 */
	...
	/**
	 * Called after this {@link Multipart} is added to a {@link MultipartStateList} instance.
	 * @param info Information that could be useful.
	 * @param entity The {@link EntityLivingBase} placing this {@link Multipart}.
	 * @param stack The {@link ItemStack} the {@link EntityLivingBase} is using.
	 */
